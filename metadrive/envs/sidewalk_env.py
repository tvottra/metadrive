...
from metadrive.component.map.long_block_map import LongBlockMap
...
class SidewalkEnv(BaseEnv):
    ...
    def _post_process_config(self, config):
        config = super(SidewalkEnv, self)._post_process_config(config)
